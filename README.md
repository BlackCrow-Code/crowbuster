...
[![License](https://img.shields.io/badge/License-MIT%20%2B%20Custom-green?style=for-the-badge)](https://github.com/BlackCrow-Code/crowbuster/blob/main/LICENSE)
[![Stars](https://img.shields.io/github/stars/BlackCrow-Code/crowbuster?style=for-the-badge&color=yellow)](https://github.com/BlackCrow-Code/crowbuster/stargazers)
...
```bash
python3 crowbuster.py -u https://example.com -w wordlist.txt -T 40 -d 2 -o live_paths.txt
```
...
|----------|--------------|----------------------------------------------|---------|
| `-u`     | `--url`      | **[Required]** The target URL                | `None`  |
| `-w`     | `--wordlist` | **[Required]** Path to your wordlist file    | `None`  |
| `-T`     | `--threads`  | Number of concurrent worker threads          | `15`    |
| `-d`     | `--depth`    | Maximum directory recursion depth            | `4`     |
| `-o`     | `--output`   | Save discovered paths to a local file        | `None`  |
...
**Developer:** [BlackCrow-Code](https://github.com/BlackCrow-Code)

This project is licensed under the **MIT License** with **Additional Custom Developer Terms**.

Please review the full [LICENSE](https://github.com/BlackCrow-Code/crowbuster/blob/main/LICENSE) alongside the [Additional Terms & Disclaimer](#️-additional-terms-disclaimer--advice) section above, which constitutes an essential condition for utilizing this software.
